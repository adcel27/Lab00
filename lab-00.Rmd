...
team_data <- tibble(
  ...
  colour = c("green", "red", "lavenderblush", 
             "hotpink", "papayawhip", "peachpuff2"),
  hobby = c("Skiing", "Football", "baketball", 
            "voleyball", "badminton", "Trampolining"),
  favourite_number = c(3, 9, 5, 4, 7, 8)
  )
